...
class UserDetailPageWidget extends StatefulWidget {
  const UserDetailPageWidget({super.key});
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(12.0, 36.0, 12.0, 12.0),
              child: Column(
            ...
            Align(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Copyright: ©️ ${functions.getCurrentYear()?.toString()} by RB News Morbi All Rights Reserved.',
