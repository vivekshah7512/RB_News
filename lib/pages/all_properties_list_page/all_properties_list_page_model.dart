...
class AllPropertiesListPageModel
  ...
  // Stores action output result for [Backend Call - API (Property List)] action in AllPropertiesListPage widget.
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        link:
            'https://app.flutterflow.io/project/r-b-news-k9jlh3/tab=uiBuilder&page=AllPropertiesListPage',
        searchReference:
            'reference=OhVBbGxQcm9wZXJ0aWVzTGlzdFBhZ2VQAVoVQWxsUHJvcGVydGllc0xpc3RQYWdl',
        widgetClassName: 'AllPropertiesListPage',
      );
}
