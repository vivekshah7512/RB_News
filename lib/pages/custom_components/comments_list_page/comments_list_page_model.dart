...
class CommentsListPageModel extends FlutterFlowModel<CommentsListPageWidget> {
  ...
  // Stores action output result for [Backend Call - API (Post News Comment)] action in Image widget.
  ...
  // Stores action output result for [Backend Call - API (Delete News Comment)] action in Image widget.
  ...
  // Stores action output result for [Backend Call - API (NewsComment)] action in Image widget.
  ApiCallResponse? _apiResult7quCopy;
  set apiResult7quCopy(ApiCallResponse? value) {
    _apiResult7quCopy = value;
    debugLogWidgetClass(this);
  }

  ApiCallResponse? get apiResult7quCopy => _apiResult7quCopy;
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        actionOutputs: {
          ...
          'apiResult7quCopy': debugSerializeParam(
            apiResult7quCopy,
            ParamType.ApiResponse,
            link:
                'https://app.flutterflow.io/project/r-b-news-k9jlh3?tab=uiBuilder&page=CommentsListPage',
