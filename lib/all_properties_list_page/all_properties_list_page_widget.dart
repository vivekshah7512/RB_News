  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (widget!.propertyType == 'all') {
        ...
        _model.apiResult9rr = await RBNewsAPIGroup.latestPropertyListCall.call(
          authToken: FFAppState().authTokenAPI,
          pageNumber: FFAppState().currentNewsPage,
          searchText: _model.textController.text,
        );

        if ((_model.apiResult9rr?.succeeded ?? true)) {
          FFAppState().totalNewsPage = functions.getDivideVars(
              getJsonField(
                (_model.apiResult9rr?.jsonBody ?? ''),
                r'''$.totalCount''',
              ),
              10);
          safeSetState(() {});
                                ...
                                onPressed: () async {
                                  if (widget!.propertyType == 'all') {
                                    ...
                                    if ((_model.apiResultg10Copy?.succeeded ??
                                      ...
                                      FFAppState().totalNewsDataSize =
                                          getJsonField(
                                        (_model.apiResultz0zCopy1?.jsonBody ??
                                            ''),
                                        r'''$.totalCount''',
                                      );
                                      safeSetState(() {});
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  if (widget!.propertyType == 'all') {
                                    ...
                                    _model.apiResultz0z1 = await RBNewsAPIGroup
                                        .latestPropertyListCall
                                        .call(
                                      authToken: FFAppState().authTokenAPI,
                                      pageNumber: FFAppState().currentNewsPage,
                                    ...
                                    if ((_model.apiResultz0z1?.succeeded ??
                                        true)) {
                                      FFAppState().totalNewsDataSize =
                                          getJsonField(
                                        (_model.apiResultz0z1?.jsonBody ?? ''),
                                        r'''$.totalCount''',
                                      );
                                      safeSetState(() {});
                                      FFAppState().totalNewsPage =
                                      ...
                                      if (FFAppState().currentNewsPage !=
                                        ...
                                        if ((_model.apiResultg101?.succeeded ??
                                            true)) {
                                          FFAppState().totalNewsDataSize =
                                              getJsonField(
                                            (_model.apiResultg101?.jsonBody ??
                                                ''),
                                            r'''$.totalCount''',
                                          );
                                          safeSetState(() {});
