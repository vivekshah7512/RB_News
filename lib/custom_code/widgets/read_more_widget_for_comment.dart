...
class ReadMoreWidgetForComment extends StatefulWidget {
  ...
  const ReadMoreWidgetForComment({
    required this.textContent,
    this.trimCharacters = 175, // Default is 125 characters
  ...
  @override
  _ReadMoreWidgetForCommentState createState() =>
      _ReadMoreWidgetForCommentState();
}

class _ReadMoreWidgetForCommentState extends State<ReadMoreWidgetForComment> {
