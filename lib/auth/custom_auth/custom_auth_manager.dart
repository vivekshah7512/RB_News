...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    rBNewsAuthUserSubject.add(
      RBNewsAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<RBNewsAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  RBNewsAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = RBNewsAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    rBNewsAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
