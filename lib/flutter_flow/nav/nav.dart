...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'HoroscopePage',
          path: '/horoscopePage',
          builder: (context, params) => const HoroscopePageWidget(),
        ),
        FFRoute(
          name: 'HomePage',
          path: '/homePage',
        ...
        FFRoute(
          ...
          path: '/newsDetailPage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'NewsDetailPage')
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'PropertyDetailPage')
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'HoroscopesDetailPage')
        ...
        FFRoute(
          ...
          path: '/userDetailPage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'UserDetailPage')
              : const UserDetailPageWidget(),
        ),
        FFRoute(
          name: 'AllPropertiesListPage',
          path: '/allPropertiesListPage',
          builder: (context, params) => const AllPropertiesListPageWidget(),
        )
